...
Before moving on, de-duplicate: `/brooks-audit`, `/brooks-debt`, and organic exploration often flag the same friction point under different names — merge overlapping signals into one candidate before presenting.
