...
name: full-review
description: >
  Comprehensive, read-only review of any code scope — a PR, a commit range, uncommitted
  ...
  it, then aggregates into one report. Never mutates code, never commits, never touches
  the tracker.
  Triggers when: user wants a full/complete technical review of a PR, diff, directory,
  or module, asks "is this safe to merge", "check this from every angle", "review this
  module", or wants a single gate covering correctness, spec, documentation, quality,
