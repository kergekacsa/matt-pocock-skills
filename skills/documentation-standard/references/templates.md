...
4. [Runbook Template](#runbook-template)
5. [Quick Start Guide Template](#quick-start-guide-template)
...
3. Check out [Development Workflows](docs/architecture/500_development_workflows_and_conventions.md)
